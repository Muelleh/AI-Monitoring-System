...
with st.sidebar:
    ...
    <div style="padding:12px 0 8px;">
      <div style="font-family:'Orbitron',monospace;color:#00e676;font-size:13px;letter-spacing:4px;font-weight:700;">⬡ PERF-AI</div>
      <div style="font-family:'Share Tech Mono',monospace;color:#37574a;font-size:9px;letter-spacing:3px;margin-top:2px;">COMMAND SYSTEM v2.0</div>
    </div>
    <hr style="border-color:#0f2a1a;margin:8px 0 16px;">
    """, unsafe_allow_html=True)

    st.markdown('<div style="font-family:\'Share Tech Mono\',monospace;color:#37574a;font-size:9px;letter-spacing:3px;margin-bottom:8px;">USER ROLE</div>', unsafe_allow_html=True)
    role = st.selectbox("", ["⬡  Coach / Commander", "◈  Athlete / Soldier"], label_visibility="collapsed")
    is_coach = "Coach" in role

    st.markdown('<hr style="border-color:#0f2a1a;margin:12px 0;">', unsafe_allow_html=True)
    st.markdown('<div style="font-family:\'Share Tech Mono\',monospace;color:#37574a;font-size:9px;letter-spacing:3px;margin-bottom:8px;">NAVIGATION</div>', unsafe_allow_html=True)
    ...
    if not is_coach:
        st.markdown('<hr style="border-color:#0f2a1a;margin:12px 0;">', unsafe_allow_html=True)
        st.markdown('<div style="font-family:\'Share Tech Mono\',monospace;color:#37574a;font-size:9px;letter-spacing:3px;margin-bottom:8px;">LOGGED IN AS</div>', unsafe_allow_html=True)
    ...
    st.markdown(f"""
    <div style="margin-top:24px;font-family:'Share Tech Mono',monospace;color:#1a3d2a;font-size:9px;letter-spacing:2px;line-height:1.8;">
      SYSTEM STATUS: <span style="color:#00e676;">ONLINE</span><br>
      OPERATORS: {len(df)}<br>
      DATE: {date.today()}<br>
      BUILD: v2.0.0
    </div>
...
if page == "team":
    ...
    k4.metric("HIGH RISK", high_risk, delta=f"{'⚠ ATTENTION' if high_risk > 0 else 'CLEAR'}", delta_color="inverse")
